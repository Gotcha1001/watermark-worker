...
export default function Editor() {
    ...
    const updateTextPreview = () => {
        ...
        if (!watermarkPreviewRef.current.style.top) {
            ...
            image.watermarkPosition.x = initialLeft;
            image.watermarkPosition.y = initialTop;
    ...
    const updateLogoPreview = () => {
        ...
        if (!logoPreviewRef.current.style.top) {
    ...
    const makeDraggable = (element) => {
        ...
        const elementDrag = (e) => {
            ...
            if (container && imageRect) {
                ...
                const maxTop = imageOffset.y + imageRect.height - elementRect.width;
                ...
                if (image) {
                    image.watermarkPosition.x = newLeft;
                    image.watermarkPosition.y = newTop;
